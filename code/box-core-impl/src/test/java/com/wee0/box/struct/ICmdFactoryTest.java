...
public class ICmdFactoryTest {
    ...
    public void test01() {
        ...
        Assertions.assertNotNull(_result);
        Assertions.assertTrue(_result.isOK());
        Assertions.assertEquals("test", _result.getMessage());
    }
    ...
    public void test02() {
        ...
        Assertions.assertNotNull(_result);
        Assertions.assertTrue(_result.isOK());
        Assertions.assertEquals(BizCodeManager.impl().getText(BizCodeDef.SaveSuccess), _result.getMessage());
    }
