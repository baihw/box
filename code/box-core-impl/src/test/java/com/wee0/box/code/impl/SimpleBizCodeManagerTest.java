...
//        bizCodeManager.addBizCodeInitializer(BizCodeExt1.Ext1Test1);
    ...
    public void testGetCodeInfo() {
        ...
        Assertions.assertNotNull(_bizCodeInfo);
        Assertions.assertEquals("系统异常，请跟管理员联系", _bizCodeInfo.getText());
        Assertions.assertEquals("系统异常，请跟管理员联系", _bizCodeInfo.formatText());

        _bizCodeInfo = bizCodeManager.getCodeInfo(BizCodeExt1.Ext1Test2, "0", "1", "2");
        Assertions.assertNotNull(_bizCodeInfo);
        Assertions.assertEquals("系统异常，请跟管理员联系。p0:{0}，p1:{1}，p2:{2}。", _bizCodeInfo.getText());
        Assertions.assertEquals("系统异常，请跟管理员联系。p0:0，p1:1，p2:2。", _bizCodeInfo.formatText());
        Assertions.assertEquals("系统异常，请跟管理员联系。p0:2，p1:1，p2:0。", _bizCodeInfo.formatText("2", "1", "0"));
        Assertions.assertEquals("系统异常，请跟管理员联系。p0:2，p1:{1}，p2:{2}。", _bizCodeInfo.formatText("2"));

        _bizCodeInfo = bizCodeManager.getCodeInfo(BizCodeExt1.Ext1Test3, "0", "1", "2");
        Assertions.assertNotNull(_bizCodeInfo);
        Assertions.assertEquals("系统异常，请跟管理员联系。p2:{2}，p1:{1}，p0:{0}。", _bizCodeInfo.getText());
        Assertions.assertEquals("系统异常，请跟管理员联系。p2:2，p1:1，p0:0。", _bizCodeInfo.formatText());
        Assertions.assertEquals("系统异常，请跟管理员联系。p2:0，p1:1，p0:2。", _bizCodeInfo.formatText("2", "1", "0"));

        _bizCodeInfo = bizCodeManager.getCodeInfo(BizCodeExt1.Ext1Test4, "0", "1", "2");
        Assertions.assertNotNull(_bizCodeInfo);
        Assertions.assertEquals("系统异常，请跟管理员联系。p0:{0}，p1:{1}，p0:{0}。", _bizCodeInfo.getText());
        Assertions.assertEquals("系统异常，请跟管理员联系。p0:0，p1:1，p0:0。", _bizCodeInfo.formatText());
        Assertions.assertEquals("系统异常，请跟管理员联系。p0:2，p1:1，p0:2。", _bizCodeInfo.formatText("2", "1", "0"));

        _bizCodeInfo = bizCodeManager.getCodeInfo(TMP_CODE1);
        Assertions.assertNotNull(_bizCodeInfo);
        Assertions.assertNull(_bizCodeInfo.getText());
        Assertions.assertNull(_bizCodeInfo.formatText());
        Assertions.assertNull(_bizCodeInfo.formatText("2", "1", "0"));
    }
    ...
    public void testGetCodeInfoI8n() {
        ...
        _bizCodeInfo = bizCodeManager.getCodeInfo(BizCodeExt1.Ext1Test2, "0", "1", "2");
        Assertions.assertNotNull(_bizCodeInfo);
        Assertions.assertEquals("system exception, please contact the administrator.p0:{0}，p1:{1}，p2:{2}。", _bizCodeInfo.getText());
        Assertions.assertEquals("system exception, please contact the administrator.p0:0，p1:1，p2:2。", _bizCodeInfo.formatText());
    ...
    public void testGetCodeInfoI8nThread() {
        ...
        Thread _thread1 = new Thread(new Runnable() {
            @Override
            public void run() {
                Assertions.assertEquals(Language.zh_CN, Locale.impl().getLanguage());
                Locale.impl().setLanguage(Language.en);
                Assertions.assertEquals(Language.en, Locale.impl().getLanguage());
        ...
        Thread _thread2 = new Thread(new Runnable() {
            ...
            public void run() {
                Assertions.assertEquals(Language.zh_CN, Locale.impl().getLanguage());
                Locale.impl().setLanguage(Language.zh_TW);
                Assertions.assertEquals(Language.zh_TW, Locale.impl().getLanguage());
