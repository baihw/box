...
public class IObjectUtilsTest {
    ...
    public void setProperty() {
        ...
        Assertions.assertEquals("str1", _obj.getString1());
    }
...
//        _data.put("PrivateString1", "private1");
        ...
        Assertions.assertEquals("s1", _obj.getString1());
        Assertions.assertTrue(_obj.isBool1());
        Assertions.assertEquals(11, _obj.getInt1());
        Assertions.assertEquals(21F, _obj.getFloat1(), 0);
        Assertions.assertEquals("private1", _obj.getPrivateString1());

        Assertions.assertNotNull(_obj.getMap1());
        Assertions.assertEquals(2, _obj.getMap1().size());
        Assertions.assertEquals("s1v", _obj.getMap1().get("s1"));
        Assertions.assertEquals("s2v", _obj.getMap1().get("s2"));
    }
