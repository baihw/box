...
//        initDefaultValues();
        ...
        try (InputStream _inStream = _getResourceAsStream(DEF_RESOURCE);) {
            System.out.println("SimpleBoxConfig load resource: ".concat(DEF_RESOURCE));
...
//            throw new BoxRuntimeException(e);
        ...
        try (InputStream _privateStream = _getResourceAsStream(DEF_PRIVATE_RESOURCE);) {
            System.out.println("SimpleBoxConfig load resource: ".concat(DEF_PRIVATE_RESOURCE));
...
//        }
    ...
    private void initDefaultValues() {
        ...
        this.DATA.put(IValidator.class.getName(), IValidator.DEF_IMPL_CLASS_NAME);
