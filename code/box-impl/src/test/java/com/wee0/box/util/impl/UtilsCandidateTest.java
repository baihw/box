...
public class UtilsCandidateTest {
    ...
    public void createFifoCache() {
        ...
        Assert.assertTrue(_cache.containsKey("k0"));

        _cache.put("k3", "v3");
        Assert.assertTrue(_cache.containsKey("k3"));
        Assert.assertFalse(_cache.containsKey("k0"));

        _cache.put("k4", "v4");
        Assert.assertTrue(_cache.containsKey("k4"));
        Assert.assertFalse(_cache.containsKey("k1"));

        _cache.get("k2");
        _cache.put("k5", "v5");
        Assert.assertTrue(_cache.containsKey("k3"));
        Assert.assertFalse(_cache.containsKey("k2"));
    }
    ...
    public void createLruCache() {
        ...
        _cache.get("k2");
        _cache.put("k5", "v5");
        Assert.assertTrue(_cache.containsKey("k2"));
