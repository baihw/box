...
public class Level2Obj {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("Level2Obj{");
    ...
    public boolean equals(Object o) {
        ...
        Level2Obj level2Obj = (Level2Obj) o;
        return Objects.equals(level3Obj, level2Obj.level3Obj) &&
                Objects.equals(string1, level2Obj.string1) &&
                Objects.equals(map1, level2Obj.map1) &&
                Objects.equals(list1, level2Obj.list1) &&
                Objects.equals(listMap1, level2Obj.listMap1);
    }

    @Override
    public int hashCode() {
        return Objects.hash(level3Obj, string1, map1, list1, listMap1);
    }
}
