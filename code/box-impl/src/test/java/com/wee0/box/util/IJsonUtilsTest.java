...
//        LEVEL3_OBJ1.setDate1(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2019-08-15 00:00:00"));
    ...
    public void test1() {
        ...
        Assert.assertEquals(LEVEL1_OBJ1, _level1Obj);
        ...
        Assert.assertEquals(LEVEL2_OBJ1, _level2Obj);
        ...
        Assert.assertEquals(LEVEL3_OBJ1, _level3Obj);

        Assert.assertEquals(LEVEL3_OBJ1, impl.readToObject(JSON_STRING1, Level3Obj.class));
        Level3Obj _level3Obj2 = new Level3Obj();
        _level3Obj2.setPrivateString1("hello, ");
        _level3Obj2.setString1("World!中文");
        Assert.assertEquals(_level3Obj2, impl.readToObject(JSON_STRING2, Level3Obj.class));
    }
