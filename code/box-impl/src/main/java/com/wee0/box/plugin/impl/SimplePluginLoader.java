 ...
 * @Description 一个简单的插件类加载器实现
 * <pre>
 * 补充说明
 * </pre>
 **/
final class SimplePluginLoader<T extends IPlugin> implements IPluginLoader<T> {

    // 日志对象
    private static ILogger log = LoggerFactory.getLogger(SimplePluginLoader.class);
    ...
    SimplePluginLoader(String id, String interfaceName, String implName, Map<String, String> config, File dir, ClassLoader parentLoader) {
