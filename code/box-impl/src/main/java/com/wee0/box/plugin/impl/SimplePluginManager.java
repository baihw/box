...
public class SimplePluginManager implements IPluginManager {
    ...
    // 日志对象
    private static ILogger log = LoggerFactory.getLogger(SimplePluginManager.class);
...
//    private final Map<String, Object> _instances = new HashMap<>(8, 1.0F);
    ...
    public void start() {
        ...
        synchronized (this) {
            ...
            for (String _id : _ids) {
                ...
                SimplePluginLoader _loader = new SimplePluginLoader(_id, _INTERFACE, _IMPL, _CONFIG, _DIR, _PARENT_LOADER);
    ...
    private static final class SimplePluginManagerHolder {
        private static final SimplePluginManager _INSTANCE = new SimplePluginManager();
    }
     ...
     * @return 当前对象唯一实例
     */
    public static SimplePluginManager me() {
        return SimplePluginManagerHolder._INSTANCE;
    }
